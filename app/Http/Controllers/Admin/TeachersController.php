...
class TeachersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teachers.index')->with(['message' => 'تم إنشاء تعريف المدرس الجديد بنجاح']);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('teachers.index')->with(['message' => 'تم تعديل تعريف المدرس الجديد بنجاح']);
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('teachers.index'))->with(['delete' => 'تم حذف تعريف المدرس بنجاح']);
    }
