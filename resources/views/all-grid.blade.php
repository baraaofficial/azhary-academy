                    ...
                    <div id="tools">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-4 d-none d-sm-block text-right">
                                <a href="#" class="bt_filters"><i class="icon-th"></i></a> <a href="all-list" class="bt_filters"><i class=" icon-list"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--End tools -->
                            ...
                            <div class="transfer_container">
                                ...
                                <div class="img_container">
                                    <a href="single_transfer.html">
                                        <img src="{{asset('website/img/transfer_2.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                    ...
                    <div class="row">
                        <div class="col-md-6 wow zoomIn" data-wow-delay="0.2s">
                            <div class="transfer_container">
                                ...
                                <div class="img_container">
                                    <a href="single_transfer.html">
                                        <img src="{{asset('website/img/transfer_3.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                                        <div class="short_info">
                        ...
                        <div class="col-md-6 wow zoomIn" data-wow-delay="0.4s">
                            <div class="transfer_container">
                                ...
                                <div class="img_container">
                                    <a href="single_transfer.html">
                                        <img src="{{asset('website/img/transfer_4.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                                        <div class="short_info">
                                            From/Per person<span class="price"><sup>$</sup>45</span>
                                        </div>
                                    </a>
