...
@section('css')
    ...
    <!-- SPECIFIC CSS -->
    <link href="{{asset('website/css/admin.css')}}" rel="stylesheet">
    <link href="{{asset('website/css/admin-rtl.css')}}" rel="stylesheet">

@endsection

@section('content')

    <section class="parallax-window" data-parallax="scroll" data-image-src="{{asset('website/img/admin_top.jpg')}}" data-natural-width="1400" data-natural-height="470">
                ...
                <div class="content">
                        ...
                        <div class="row">
                                ...
                                <div class="hotel_container">
                                    <div class="img_container">
                                        <a href="single_hotel.html">
                                            <img src="{{asset('website/img/hotel_1.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                            ...
                            <div class="col-lg-4 col-md-6 ">
                                <div class="hotel_container">
                                    <div class="img_container">
                                        <a href="single_hotel.html">
                                            <img src="{{asset('website/img/hotel_2.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                                            <div class="ribbon top_rated">
                                            </div>
                                            <div class="score">
                                ...
                                <div class="transfer_container">
                                    <div class="img_container">
                                        <a href="single_transfer.html">
                                            <img src="{{asset('website/img/transfer_1.jpg')}}" width="800" height="533" class="img-fluid" alt="Image">
                                            <div class="ribbon top_rated">
                                            </div>
                                            <div class="short_info">
                    ...
                    <section id="section-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p>
                                    <img src="{{asset('website/img/tourist_guide_pic.jpg')}}" alt="Image" class="img-fluid styled profile_pic">
                                </p>
                            </div>
                        </div>
                        <!-- End row -->
