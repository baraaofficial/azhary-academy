...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">لوحة التحكم</span> -  تعديل المدرس {{$model->name}}</h4>
        ...
        <div class="content">
            ...
            {!! Form::model($model,[
                'action'  => ['Admin\TeachersController@update',$model->id],
                'method'  =>'put',
                'files'   =>   true,
            ...
            <button type="submit" class="btn btn-primary ml-3">تعديل المدرس {{$model->name}} <i class="icon-paperplane ml-2"></i></button>
