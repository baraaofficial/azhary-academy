...
@section('content')
    ...
    <div class="content-wrapper">
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item active">انشاء أختبار جديد</span>
                    </div>
        ...
        <div class="content">
            ...
            {!! Form::model($model,[
                'action'  => 'Admin\TestController@store',
                'method'  =>'post',
            ...
            <button type="submit" class="btn btn-primary ml-3">انشاء الأختبار <i class="icon-paperplane ml-2"></i></button>
