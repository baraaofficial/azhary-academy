...
@inject('model','App\Models\QuestionsOption')
@section('title')
    انشاء اختيار جديد
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-right6 mr-2"></i> <span class="font-weight-semibold">لوحة التحكم</span> - اختيارات الاسئلة</h4>
            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <a href="{{url('/dashboard/questions_options')}}" class="breadcrumb-item"><i class="icon-stack2 mr-2"></i>جميع اختيارات الأسئلة</a>
                        <span class="breadcrumb-item active">انشاء اختيار جديد</span>
                    </div>
        ...
        <div class="content">
            ...
            {!! Form::model($model,[
                'action'  => 'Admin\QuestionsOptionsController@store',
                'method'  => 'post',
                'files'   =>  true,
            ...
            <button type="submit" class="btn btn-primary ml-3">انشاء اختيار جديد <i class="icon-paperplane ml-2"></i></button>
