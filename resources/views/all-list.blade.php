        ...
        <div class="container margin_60">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                            ...
                            <div class="col-md-3 col-sm-4 col-6">
                                <div class="styled-select-filters">
                                    <select name="sort_price" id="sort_price">
                                        <option value="" selected>اولي ثانوي</option>
                                        <option value="lower">تانيه ثانوي</option>
                                        <option value="higher">تالته ثانوي</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-4 col-6">
                                <div class="styled-select-filters">
                                    <select name="sort_rating" id="sort_rating">
                                        <option value="" selected>الانجليزي</option>
                                        <option value="lower">الجغرافيا</option>
                                        <option value="higher">التاريخ</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-4 d-none d-sm-block text-right">
                                <a href="all-grid" class="bt_filters"><i class="icon-th"></i></a> <a href="#" class="bt_filters"><i class=" icon-list"></i></a>
                            </div>
                    ...
                    <div cla ss="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_transfer.html"><img src="{{asset('website/img/transfer_2.jpg')}}" alt="Image">
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_transfer.html"><img src="{{asset('website/img/transfer_1.jpg')}}" alt="Image">
                                        <div class="short_info"></div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_transfer.html"><img src="{{asset('website/img/transfer_3.jpg')}}" alt="Image">
                                        <div class="short_info"></div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_transfer.html"><img src="{{asset('website/img/transfer_4.jpg')}}" alt="Image">
                                        <div class="short_info"></div>
                                    </a>
                                </div>
                            </div>
