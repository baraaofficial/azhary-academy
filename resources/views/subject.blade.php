...
@section('content')
    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            <h1>أكاديمية أزهري  - جميع الدورات بحسب المواد </h1>
            <span>هنا جميع الدورات بتصنيف كل مادة</span>
            <ol class="breadcrumb">
                ...
                <div class="postcontent nobottommargin col_last">
                    ...
                    <ul id="portfolio-filter" class="portfolio-filter clearfix" data-container="#portfolio">
                        ...
                        @foreach($get_subject as $subject)
                            <li><a href="subject{{route('subject.index',$subject->id)}}" data-filter=".subject{{$subject->id}}">{{$subject->name}}</a></li>
                        @endforeach
