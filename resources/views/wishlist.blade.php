...
@section('content')
    ...
    <section class="parallax-window" data-parallax="scroll" data-image-src="{{asset('website/img/home_bg_1.jpg')}}" data-natural-width="1400" data-natural-height="470">
                        ...
                        <div class="collapse show" id="collapseFilters">
                            <div class="filter_type">
                                ...
                                <ul>
                                    <li>
                                        <label>
                                            <input type="checkbox" checked>From $10 to $50</label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">From $50 to $80</label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">From $80 to $100</label>
                                    </li>
                                </ul>
                            </div>
                            <div class="filter_type">
                            ...
                            <div class="filter_type">
                                ...
                                <ul>
                                    <li>
                                        <label>
                                            <input type="checkbox">City tours</label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">Hotels</label>
                                    </li>
                                    <li>
                                        <label>
                                            <input type="checkbox">Transfers</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_tour.html">
                                        <div class="ribbon popular"></div><img src="{{asset('website/img/tour_box_1.jpg')}}" alt="Image">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_hotel.html">
                                        <div class="ribbon top_rated"></div><img src="{{asset('website/img/hotel_2.jpg')}}" alt="Image">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_transfer.html">
                                        <div class="ribbon top_rated"></div><img src="{{asset('website/img/transfer_3.jpg')}}" alt="Image">
                                    </a>
                    ...
                    <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.7s">
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="img_list">
                                    <a href="single_tour.html">
                                        <div class="ribbon top_rated"></div><img src="{{asset('website/img/tour_box_5.jpg')}}" alt="Image">
...
@section('script')
    <!-- Cat nav mobile -->
    <script src="{{asset('website/js/cat_nav_mobile.js')}}"></script>
    <script>
        $('#cat_nav').mobileMenu();
    </script>
    <!-- Map -->
